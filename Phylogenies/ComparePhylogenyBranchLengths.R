...
CreateBirthDeathBranchingTimes <- function(n_taxa = 10, birth_rate = 1.0, death_rate = 0.0)
{
...
CreateCoalescentBranchingTimes <- function(n_taxa = 10)
{
...
birth_rate <- 0.2
death_rate <- 0.01
model1 <- CreateBirthDeathBranchingTimes(n_taxa,birth_rate,death_rate)
model2 <- CreateCoalescentBranchingTimes(n_taxa)
