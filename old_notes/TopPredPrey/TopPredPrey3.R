...
F = 4.9                # A non-dimensional parameter linked to consumption of predator 
frac=0.01              # 0.01 - Fraction of area with predators 
frac_top=0.0001              # 0.01 - Fraction of area with toppredators 

# Simulation parameters
Length=10             # 512  - The length of the simulated landscape, in meters
m=10                  # 128  - # gridcellen
dT=0.2                 # 0.2  - timestep
EndTime=200           #      - Time at which the simulation ends
Numframes=50          #      - Number of frames displayed during the entire simulation
...
#   windows(width = WinWidth, height = WinHeight,
#           title="Predator-prey model")
par(mfrow=c(1,1), mar=c(3, 4, 2, 6) + 0.1)
