...
mv average_nltts.png example_12_average_nltts.png
mv nltt_stats_histogram.png example_12_nltt_stats_histogram.png
Rscript do_analyze.R example_3.RDa
Rscript do_analyze.R example_4.RDa
Rscript do_analyze.R example_3.RDa example_4.RDa
mv average_nltts.png example_34_average_nltts.png
mv nltt_stats_histogram.png example_34_nltt_stats_histogram.png